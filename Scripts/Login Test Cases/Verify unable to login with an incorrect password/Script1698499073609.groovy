...
WebUI.verifyElementPresent(findTestObject('Object Repository/TimeSheet_Login_Page/Page_Test Automation Practice Working with _91906a/div_Password should be between 6 and 30 characters'), 
    0)

WebUI.setEncryptedText(findTestObject('Object Repository/TimeSheet_Login_Page/Page_Test Automation Practice Working with _91906a/input_Forgot password_password'), 
    'KWLIJzHkN9g6uWx8aIe25g==')

WebUI.click(findTestObject('Object Repository/TimeSheet_Login_Page/Page_Test Automation Practice Working with _91906a/button_Login'))

WebUI.verifyElementPresent(findTestObject('Object Repository/TimeSheet_Login_Page/Page_Test Automation Practice Working with _91906a/div_Incorrect email address or password'), 
    0)
