...
WebUI.verifyElementPresent(findTestObject('Object Repository/Registration_Page/Page_Test Automation Practice Working with _91906a/div_An account already exists with the same_6406a4'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/Registration_Page/Page_Test Automation Practice Working with _91906a/div_An account already exists with the same_6406a4'), 
