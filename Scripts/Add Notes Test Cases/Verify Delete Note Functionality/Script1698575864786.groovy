...
WebUI.click(findTestObject('Object Repository/Notes_Page/Page_Test Automation Practice Working with _91906a/button_Delete'))

WebUI.click(findTestObject('Object Repository/Notes_Page/Page_Test Automation Practice Working with _91906a/button_Delete_1'))
